...
import static sun.security.smartcardio.PCSC.SCARD_E_CANCELLED;
import static sun.security.smartcardio.PCSC.SCARD_E_CANT_DISPOSE;
import static sun.security.smartcardio.PCSC.SCARD_E_CARD_UNSUPPORTED;
import static sun.security.smartcardio.PCSC.SCARD_E_DUPLICATE_READER;
import static sun.security.smartcardio.PCSC.SCARD_E_INSUFFICIENT_BUFFER;
import static sun.security.smartcardio.PCSC.SCARD_E_INVALID_ATR;
import static sun.security.smartcardio.PCSC.SCARD_E_INVALID_HANDLE;
import static sun.security.smartcardio.PCSC.SCARD_E_INVALID_PARAMETER;
import static sun.security.smartcardio.PCSC.SCARD_E_INVALID_TARGET;
import static sun.security.smartcardio.PCSC.SCARD_E_INVALID_VALUE;
import static sun.security.smartcardio.PCSC.SCARD_E_NOT_READY;
import static sun.security.smartcardio.PCSC.SCARD_E_NOT_TRANSACTED;
import static sun.security.smartcardio.PCSC.SCARD_E_NO_MEMORY;
import static sun.security.smartcardio.PCSC.SCARD_E_NO_READERS_AVAILABLE;
import static sun.security.smartcardio.PCSC.SCARD_E_NO_SERVICE;
import static sun.security.smartcardio.PCSC.SCARD_E_NO_SMARTCARD;
import static sun.security.smartcardio.PCSC.SCARD_E_PCI_TOO_SMALL;
import static sun.security.smartcardio.PCSC.SCARD_E_PROTO_MISMATCH;
import static sun.security.smartcardio.PCSC.SCARD_E_READER_UNAVAILABLE;
import static sun.security.smartcardio.PCSC.SCARD_E_READER_UNSUPPORTED;
import static sun.security.smartcardio.PCSC.SCARD_E_SERVICE_STOPPED;
import static sun.security.smartcardio.PCSC.SCARD_E_SHARING_VIOLATION;
import static sun.security.smartcardio.PCSC.SCARD_E_SYSTEM_CANCELLED;
import static sun.security.smartcardio.PCSC.SCARD_E_TIMEOUT;
import static sun.security.smartcardio.PCSC.SCARD_E_UNKNOWN_CARD;
import static sun.security.smartcardio.PCSC.SCARD_E_UNKNOWN_READER;
import static sun.security.smartcardio.PCSC.SCARD_E_UNSUPPORTED_FEATURE;
import static sun.security.smartcardio.PCSC.SCARD_F_COMM_ERROR;
import static sun.security.smartcardio.PCSC.SCARD_F_INTERNAL_ERROR;
import static sun.security.smartcardio.PCSC.SCARD_F_UNKNOWN_ERROR;
import static sun.security.smartcardio.PCSC.SCARD_F_WAITED_TOO_LONG;
import static sun.security.smartcardio.PCSC.SCARD_S_SUCCESS;
import static sun.security.smartcardio.PCSC.SCARD_W_INSERTED_CARD;
import static sun.security.smartcardio.PCSC.SCARD_W_REMOVED_CARD;
import static sun.security.smartcardio.PCSC.SCARD_W_RESET_CARD;
import static sun.security.smartcardio.PCSC.SCARD_W_UNPOWERED_CARD;
import static sun.security.smartcardio.PCSC.SCARD_W_UNRESPONSIVE_CARD;
import static sun.security.smartcardio.PCSC.SCARD_W_UNSUPPORTED_CARD;
import static sun.security.smartcardio.PCSC.WINDOWS_ERROR_INVALID_HANDLE;
import static sun.security.smartcardio.PCSC.WINDOWS_ERROR_INVALID_PARAMETER;
